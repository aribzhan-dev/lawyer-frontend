...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-dark-950 border-t border-gray-200/60 dark:border-dark-800/60">
      {/* Main footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-5">
              ...
              <div>
                <span translate="no" className="font-serif text-xl font-semibold text-gray-900 dark:text-dark-50 whitespace-nowrap">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex flex-col gap-2 text-gray-500 dark:text-dark-400 text-sm">
                {COMPANY_PHONES.map((phone) => (
                  <div key={phone.href} className="flex items-center gap-3">
                    ...
                    <a href={phone.href} className="hover:text-gold-400 transition-colors">
                      {phone.display}
                    </a>
                  </div>
                ))}
              ...
              <li className="flex items-center gap-3 text-gray-500 dark:text-dark-400 text-sm">
                ...
                <a href={`mailto:${COMPANY_EMAIL}`} className="hover:text-gold-400 transition-colors">
                  {COMPANY_EMAIL}
                </a>
              </li>
            </ul>
      ...
      {/* Bottom bar */}
      <div className="border-t border-gray-200/60 dark:border-dark-800/60">
        <div className="container-max px-4 sm:px-6 lg:px-8 py-5">
          <p className="text-gray-500 dark:text-dark-500 text-xs text-center">
