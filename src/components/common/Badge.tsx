...
const variants = {
  ...
  dark: 'bg-gray-100/60 dark:bg-gray-100 dark:bg-dark-700/60 text-gray-600 dark:text-dark-300 border-gray-300/40 dark:border-gray-300 dark:border-dark-600/40',
