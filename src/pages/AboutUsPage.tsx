import { Scale, Shield, Clock, Users, Eye, CheckCircle, FileText, MapPin, Phone, Mail, ChevronRight } from 'lucide-react';
...
export default function AboutUsPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-dark-950 pt-24 pb-20">
      {/* ── Hero Header ─────────────────────────────────────────── */}
      <section className="relative bg-gradient-to-b from-gray-50 to-white dark:from-dark-900 dark:to-dark-950 border-b border-gray-200/60 dark:border-dark-800/60 py-16 overflow-hidden">
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-semibold text-gray-900 dark:text-dark-50 leading-tight mb-4">
            {t('about.page_title1')}
            <br />
            <span className="gold-text">{t('about.page_title2')}</span>
          </h1>
      ...
      <div className="container-max px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-12">
          ...
          <div className="glass-card p-8">
            ...
            <h2 className="font-serif text-2xl text-gray-900 dark:text-dark-50 mb-3">
        ...
        <section className="py-10 border-t border-gray-200/60 dark:border-dark-800/60">
          <div className="max-w-3xl">
            <h2 className="font-serif text-3xl text-gray-900 dark:text-dark-50 mb-2">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {competenceItems.map((item, i) => (
                  <li key={i} className="flex items-center gap-2.5 text-sm text-gray-600 dark:text-dark-300">
        ...
        <section className="py-10 border-t border-gray-200/60 dark:border-dark-800/60">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {steps.map((step) => (
              ...
              >
                <span className="font-serif text-3xl text-gold-500/30 font-semibold leading-none">
                  {step.num}
                </span>
        ...
        <section className="py-10 border-t border-gray-200/60 dark:border-dark-800/60">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Manzil */}
            <div>
              <h2 className="font-serif text-2xl text-gray-900 dark:text-dark-50 mb-2">
              ...
              <div className="flex items-start gap-3 text-gray-600 dark:text-dark-300 text-sm">
                ...
                <span className="leading-relaxed">
                  Казахстан, город Шымкент,<br />
                  район Тұран, Микрорайон 8,<br />
                  дом 54, кв. 18<br />
                  <span className="text-gray-400 dark:text-dark-500 text-xs mt-1 block">Индекс: 160000</span>
                </span>
              </div>
              {/* Ish vaqti */}
              <div className="mt-4 glass-card p-4">
                <p className="text-gray-500 dark:text-dark-400 text-xs font-semibold uppercase tracking-wider mb-2">Время работы</p>
                <p className="text-gray-600 dark:text-dark-300 text-sm">Понедельник – Пятница: 09:00–18:00</p>
                <p className="text-gray-400 dark:text-dark-500 text-sm">Суббота, Воскресенье: выходные дни</p>
              </div>
            </div>
